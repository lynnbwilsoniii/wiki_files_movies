...
\begin{subequations}
  \begin{align}
    \frac{ \partial f^{(m)} }{ \partial n{\scriptstyle_{o}} } & = \frac{ f^{(m)} }{ n{\scriptstyle_{o}} } \label{eq:deriv_mdf3} \\
    \frac{ \partial f^{(m)} }{ \partial V{\scriptstyle_{T \parallel}} } & = \left[ \frac{ 2 \ \left( w{\scriptstyle_{\parallel}}^{2} - 1 \right) }{ V{\scriptstyle_{T \parallel}} } \right] \ f^{(m)} \label{eq:deriv_mdf4} \\
    \frac{ \partial f^{(m)} }{ \partial V{\scriptstyle_{T \perp}} } & = \left[ \frac{ 2 \ \left( w{\scriptstyle_{\perp}}^{2} - 1 \right) }{ V{\scriptstyle_{T \perp}} } \right] \ f^{(m)} \label{eq:deriv_mdf5} \\
    \frac{ \partial f^{(m)} }{ \partial v{\scriptstyle_{o \parallel}} } & = \left( \frac{ 2 \ w{\scriptstyle_{\parallel}} }{ V{\scriptstyle_{T \parallel}} } \right) \ f^{(m)} \label{eq:deriv_mdf6} \\
    \frac{ \partial f^{(m)} }{ \partial v{\scriptstyle_{o \perp}} } & = \left( \frac{ 2 \ w{\scriptstyle_{\perp}} }{ V{\scriptstyle_{T \perp}} } \right) \ f^{(m)} \label{eq:deriv_mdf7}
%%    \left(  \right)
%%    \left[  \right]
%%    \frac{  }{  }
%%    \left( \frac{  }{  } \right)
...
\begin{subequations}
  \begin{align}
    \frac{ \partial f^{(\kappa)} }{ \partial n{\scriptstyle_{o}} } & = \frac{ f^{(\kappa)} }{ n{\scriptstyle_{o}} } \label{eq:deriv_kdf3} \\
    \frac{ \partial f^{(\kappa)} }{ \partial V{\scriptstyle_{T \parallel}} } & = \left[ \frac{ 2 \ w{\scriptstyle_{\parallel}}^{2} \ \left( \kappa + \tfrac{1}{2} \right) - w{\scriptstyle_{\perp}}^{2} - \left( \kappa - \tfrac{3}{2} \right) }{ V{\scriptstyle_{T \parallel}} \ D\left( w{\scriptstyle_{\parallel}}, w{\scriptstyle_{\perp}}, \kappa \right) } \right] \ f^{(\kappa)} \label{eq:deriv_kdf4} \\
    \frac{ \partial f^{(\kappa)} }{ \partial V{\scriptstyle_{T \perp}} } & = \left\{ \frac{ 2 \ \left[ \kappa \ w{\scriptstyle_{\perp}}^{2} - w{\scriptstyle_{\parallel}}^{2} - \left( \kappa - \tfrac{3}{2} \right) \right] }{ V{\scriptstyle_{T \perp}} \ D\left( w{\scriptstyle_{\parallel}}, w{\scriptstyle_{\perp}}, \kappa \right) } \right\} \ f^{(\kappa)} \label{eq:deriv_kdf5} \\
    \frac{ \partial f^{(\kappa)} }{ \partial V{\scriptstyle_{o \parallel}} } & = \left[ \frac{ 2 \ w{\scriptstyle_{\parallel}} \ \left( \kappa + 1 \right) }{ V{\scriptstyle_{T \parallel}} \ D\left( w{\scriptstyle_{\parallel}}, w{\scriptstyle_{\perp}}, \kappa \right) } \right] \ f^{(\kappa)} \label{eq:deriv_kdf6} \\
    \frac{ \partial f^{(\kappa)} }{ \partial V{\scriptstyle_{o \perp}} } & = \left[ \frac{ 2 \ w{\scriptstyle_{\perp}} \ \left( \kappa + 1 \right) }{ V{\scriptstyle_{T \perp}} \ D\left( w{\scriptstyle_{\parallel}}, w{\scriptstyle_{\perp}}, \kappa \right) } \right] \ f^{(\kappa)} \label{eq:deriv_kdf7} \\
    \frac{ \partial f^{(\kappa)} }{ \partial \kappa } & = \left\{ \frac{ \left( w{\scriptstyle_{\parallel}}^{2} + w{\scriptstyle_{\perp}}^{2} \right) \left( \kappa - \tfrac{1}{2} \right) - \tfrac{3}{2} \ \left( \kappa - \tfrac{3}{2} \right) }{ \left( \kappa - \tfrac{3}{2} \right) \ D\left( w{\scriptstyle_{\parallel}}, w{\scriptstyle_{\perp}}, \kappa \right) } - \ln{ \lvert 1 + \frac{ w{\scriptstyle_{\parallel}}^{2} + w{\scriptstyle_{\perp}}^{2} }{ \left( \kappa - \tfrac{3}{2} \right) } \rvert } + \psi\left( \kappa + 1 \right) - \psi\left( \kappa - \tfrac{1}{2} \right) \right\} \ f^{(\kappa)} \label{eq:deriv_kdf8}
%%    \left(  \right)
%%    \left[  \right]
%%    \frac{  }{  }
%%    \left( \frac{  }{  } \right)
...
\begin{subequations}
  \begin{align}
    \frac{ \partial f^{(s)} }{ \partial n{\scriptstyle_{o}} } & = \frac{ f^{(s)} }{ n{\scriptstyle_{o}} } \label{eq:deriv_sdf3} \\
    \frac{ \partial f^{(s)} }{ \partial V{\scriptstyle_{T \parallel}} } & = \left( \frac{ p \ w{\scriptstyle_{\parallel}}^{p} - 1 }{ V{\scriptstyle_{T \parallel}} } \right) \ f^{(s)} \label{eq:deriv_sdf4} \\
    \frac{ \partial f^{(s)} }{ \partial V{\scriptstyle_{T \perp}} } & = \left( \frac{ p \ w{\scriptstyle_{\perp}}^{p} - 2 }{ V{\scriptstyle_{T \perp}} } \right) \ f^{(s)} \label{eq:deriv_sdf5} \\
    \frac{ \partial f^{(s)} }{ \partial v{\scriptstyle_{o \parallel}} } & = \left( \frac{ p \ w{\scriptstyle_{\parallel}}^{p - 1} }{ V{\scriptstyle_{T \parallel}} } \right) \ f^{(s)} \label{eq:deriv_sdf6} \\
    \frac{ \partial f^{(s)} }{ \partial v{\scriptstyle_{o \perp}} } & = \left( \frac{ p \ w{\scriptstyle_{\perp}}^{p - 1} }{ V{\scriptstyle_{T \perp}} } \right) \ f^{(s)} \label{eq:deriv_sdf7} \\
    \frac{ \partial f^{(s)} }{ \partial p } & = \left[ \frac{ 3 \ \psi\left( \frac{ 1 + p }{ p } \right) }{ p^{2} } - w{\scriptstyle_{\parallel}}^{p} \ \ln{ w{\scriptstyle_{\parallel}} } - w{\scriptstyle_{\perp}}^{p} \ \ln{ w{\scriptstyle_{\perp}} } \right] \ f^{(s)} \label{eq:deriv_sdf8}
%%    \left(  \right)
%%    \left[  \right]
%%    \frac{  }{  }
%%    \left( \frac{  }{  } \right)
...
\begin{subequations}
  \begin{align}
    ...
    \frac{ 1 }{ f^{(s2)} } \frac{ \partial f^{(s2)} }{ \partial p } & = \frac{ \psi\left( \frac{ 1 + p }{ p } \right) }{ p^{2} } - w{\scriptstyle_{\parallel}}^{p} \ \ln{ w{\scriptstyle_{\parallel}} } \label{eq:deriv_s2df8} \\
    \frac{ 1 }{ f^{(s2)} } \frac{ \partial f^{(s2)} }{ \partial q } & = \frac{ 2 \ \psi\left( \frac{ 1 + q }{ q } \right) }{ q^{2} } - w{\scriptstyle_{\perp}}^{q} \ \ln{ w{\scriptstyle_{\perp}} } \label{eq:deriv_s2df9}
%%    \left(  \right)
%%    \left[  \right]
%%    \frac{  }{  }
%%    \left( \frac{  }{  } \right)
